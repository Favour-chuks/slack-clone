...
parentMesageId: v.optional(v.id("messages")),
conversationId: v.optional(v.id("conversations"))
 ...
 handler: async (ctx, args) => {
  ...
  const messageId = await ctx.db.insert("messages", {
   ...
   parentMessageId: args.parentMesageId,
  })
         ...
         page: (
             await Promise.all(
                 results.page.map(async (message) => {
                     ...
                     const dedupedReactons = reactionsWithCounts.reduce(
                         (acc, reaction) => {
                     ...
                     const reactionsWithoutMemberIdProperity = dedupedReactons.map(
                        ({memberId, ...rest}) => rest,
                     );
                     ...
                     return {
                        ...
                        member,
                        user,
                        reactions: reactionsWithoutMemberIdProperity,
