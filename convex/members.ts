...
export const remove = mutation({
  ...
  handler: async (ctx, args) => {
    ...
    if(member.role === "admin") throw new Error("Admin canot be removed");

    if(currentMember._id === args.id && currentMember.role === "admin") throw new Error("Cannot remove self is self is an admin");
